...
public:
	...
	long* numerador() const;

	long* denominador() const;

	void setNumerador(long numer);
	void setDenominador(long denom);
	//Constructor
	Racional(long num, long dem);
	...
	Racional& operator*=(const Racional& R1);
	Racional& divideYActualiza( Racional& R1);
	Racional& suma(const Racional& R1);
